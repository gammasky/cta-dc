...
def make_plot(num_plot, color_scale, fluxes_cu,fluxes_cu_2,fluxes_cu_3,fluxes_cu_4,fluxes_cu_5):
   ...
   # import IPython; IPython.embed();
    ...
    for ii in range(len(y)):
         ...
         #ybright = y_4[ii] +y_5[ii]
         y_sum.append(ysum)
         #y_bright.append(ybright)
         # print(y[ii], y_2[ii], y_3[ii], y_4[ii], y_5[ii], y_sum[ii], y_bright[ii])
         print(y[ii], y_2[ii], y_sum[ii])



    #hist_sum, bin_edges_sum = np.histogram(y_sum,bins=bins)
    plt.step(bins[::-1], y_sum, color=color_scale[5], lw=2)
...
if __name__ == '__main__':
    num_plot = 2
    color_scale = ['red','blue','green','magenta','yellow','black']
    ...
    make_plot(num_plot, color_scale, fluxes_cu_gammacat, fluxes_cu_images, fluxes_cu_images, fluxes_cu_images, fluxes_cu_gammacat)
